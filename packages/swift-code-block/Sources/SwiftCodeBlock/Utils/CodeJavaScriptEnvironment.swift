...
struct CodeJavaScriptResource: Equatable, Sendable {
    var name: String
    var subdir: String?
...
final class CodeJavaScriptEnvironment: @unchecked Sendable {
    private let name: String
    private let scripts: [CodeJavaScriptResource]
    ...
    init(
        name: String,
        scripts: [CodeJavaScriptResource],
    ...
    func call<Result: Decodable>(
        ...
        #if canImport(JavaScriptCore)
            let invocation = CodeJavaScriptInvocation(method: method, arguments: arguments)
        ...
        private func evaluate(_ resource: CodeJavaScriptResource, in context: JSContext) -> Bool {
            guard
                let url =
                    bundle.url(
...
private struct CodeJavaScriptInvocation: @unchecked Sendable {
    var method: String
    var arguments: [Any]
}
